...
SKILL_REGISTRY: dict[str, dict[str, str]] = {
    "track": {
        "name": "track",
        "description": "Daily tracking & habits (exercise, study, routines, diet)",
        "keywords": "추적,습관,운동,공부,루틴,다이어트,체크,매일,기록일지,출석",
    },
    "collect": {
        "name": "collect",
        "description": "Collect & record items (wine, books, recipes, movies, archives)",
        "keywords": "수집,기록,노트,와인,독서,맛집,영화,레시피,아카이브,리뷰,컬렉션,시음",
    },
    "manage": {
        "name": "manage",
        "description": "Process & status management (projects, hiring, sales, bugs)",
        "keywords": "관리,프로젝트,채용,영업,버그,파이프라인,스프린트,칸반,태스크,업무",
    },
    "plan": {
        "name": "plan",
        "description": "Planning & scheduling (wedding, travel, moving, exams, events)",
        "keywords": "계획,일정,결혼,여행,이사,시험,행사,준비,D-day,할일,체크리스트",
    },
    "organize": {
        "name": "organize",
        "description": "Organize & structure info (bookmarks, contacts, budget, inventory)",
        "keywords": "정리,북마크,연락처,가계부,재고,목록,분류,카탈로그,즐겨찾기",
    },
    "guide": {
        "name": "guide",
        "description": "Guides & documentation (onboarding, manuals, FAQ, wiki)",
        "keywords": "안내,온보딩,인수인계,매뉴얼,가이드,FAQ,위키,설명서,신입",
    },
    "hub": {
        "name": "hub",
        "description": "Dashboard & home pages (team home, workspace, project hub)",
        "keywords": "대시보드,홈,허브,워크스페이스,메인,한눈에,전체,팀",
    },
}
